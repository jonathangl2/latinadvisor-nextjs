        ...
        const htmlTeamCArousel = (data) => {
            return `<div class="item px-5 pt-5 d-flex align-items-center">
                <div class="card card-team">
                    <div class="card-body">
                        <div class="img-bg" style="background-image: url('/latinadvisor-nextjs/assets/images/conocenos/team/${data?.img_bg}');">
                            <p>${data.description_team}</p>
                        </div>
                        <div class="img-front" style="background-image: url('/latinadvisor-nextjs/assets/images/conocenos/team/${data.img_front}');"></div>
                    </div>
